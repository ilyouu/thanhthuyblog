...
class Model
{
    ...
    function tag()
    {
        $query = "select * from tag ORDER BY MaTag ASC; ";
    ...
    function delete($id)
    {
        ...
        if ($status == true) {
            ...
            setcookie('msg', 'Xóa không thành công, hình như có lỗi gì đó!', time() + 2);
        }
    ...
    function store($data)
    {
        ...
        if ($status == true) {
            ...
            setcookie('msg', 'Thêm vào không thành công, hình như có lỗi gì đó!', time() + 2);
    ...
    function update($data)
    {
        ...
        if ($result == true) {
            ...
            setcookie('msg', 'Sửa không thành công, hình như có lỗi gì đó!', time() + 2);
